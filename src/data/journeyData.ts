...
export const journeyPosts: JourneyPost[] = [
  ...
  },
  {
    ...
    "content": "I just graduated with a Bachelor of Science in Microbiology degree. One chapter closes, with a bittersweet experience, and next one begins. Starting next week, I will be working towards my Postgrad degree at IISER Thiruvananthapuram.",
    "imagePath": "/images/blog/MS.jpg",
    "imageAlt": "MS Diploma"
  },
  {
    "id": "5",
  ...
  },
  {
    ...
    "type": "text",
    "title": "DBT JRF",
    "content": "I am super stoked to share that I have cleared the Department of Biotechnology's Biotechnology Entrance Test (DBT-BET) under Category-I. And as such, will be getting a Junior Research Fellowship from DBT!",
    "imagePath": "/images/journey/DBT.jpg",
  ...
  },
  {
    ...
    "type": "text",
    "title": "IELTS",
    "content": "Got my IELTS score yesterday. I think I did well. Writing section could have been better. But a band 8.0 overall!!",
    "imagePath": "/images/journey/IELTS.jpg",
  ...
  },
  {
    ...
    "content": "Got my GRE score recently. Scored a (decent) 322 in General, with a 160 in Verbal and a 162 in Quantitative Reasoning. In the Subject-Biology test, I scored a rather diasspointing 800. I definitely should have studied more on Ecology and Evolution (but I found it so boring!). Lesson learnt!",
    "imagePath": "/images/journey/GRE.jpg",
    "imageAlt": "GRE Scorecard"
  }
];
